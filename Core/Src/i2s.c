...
void MX_I2S2_Init(void)
{
  ...
  SET_BIT(hi2s2.Instance->CFG2, SPI_CFG2_IOSWP); //TODO: (это фикс куба) убрать когда пофиксят STM32CubeMX
...
void HAL_I2S_MspInit(I2S_HandleTypeDef* i2sHandle)
{
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = I2S_CLK_Pin|I2S_WS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
...
void HAL_I2S_MspDeInit(I2S_HandleTypeDef* i2sHandle)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB12     ------> I2S2_WS
    */
    HAL_GPIO_DeInit(I2S_DOUT_GPIO_Port, I2S_DOUT_Pin);

    HAL_GPIO_DeInit(GPIOB, I2S_CLK_Pin|I2S_WS_Pin);
